...
function App() {
  ...
  const mntmessage = (
    <Notification type={'info'} header={'please wait'} closable>
  ...
  const claimNFTs = () => {
    ...
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        console.log(receipt);
        setFeedback(
          `${CONFIG.NFT_NAME} NFT mint was successful!`
        );
      ...
      >
        ...
        <s.SpacerSmall/>
           ...
           {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                <s.TextSub
                  style={{ textAlign: "center", color: "#383737", fontFamily: "coder"  }}
                >
                ...
                blockchain.smartContract === null ? (
                  ...
                  <>
                    ...
                    <br></br>Max {CONFIG.MAX_PER_TX} Per Tx
                    </s.TextSubTitle>
                    <s.SpacerXSmall/>
